...
function(a){for(var a=a.split("."),b=window,c=0;c<a.length;c++)b[a[c]]||(b[a[c]]={}),b=b[a[c]]};GeoGlobe.VERSION_NUMBER="GeoGlobeJSAPI 2018 -- $Version: 0.44.2 build-2019/5/24 17:10:35 $"})();GeoGlobe.Class=function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d=typeof c.initialize=="function"?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};a>1?[d,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c):d.prototype=c;return d};
...
GeoGlobe.Util.distVincenty=function(a,b){for(var c=GeoGlobe.Util.VincentyConstants,d=c.a,e=c.b,c=c.f,f=GeoGlobe.Util.rad(b.lng-a.lng),g=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(a.lat))),h=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(b.lat))),j=Math.sin(g),g=Math.cos(g),l=Math.sin(h),h=Math.cos(h),m=f,o=2*Math.PI,q=20;Math.abs(m-o)>1.0E-12&&--q>0;){var r=Math.sin(m),n=Math.cos(m),p=Math.sqrt(h*r*h*r+(g*l-j*h*n)*(g*l-j*h*n));if(p==0)return 0;var n=j*l+g*h*n,t=Math.atan2(p,n),s=Math.asin(g*h*r/p),u=
Math.cos(s)*Math.cos(s),r=n-2*j*l/u,v=c/16*u*(4+c*(4-3*u)),o=m,m=f+(1-v)*c*Math.sin(s)*(t+v*p*(r+v*n*(-1+2*r*r)))}if(q==0)return NaN;d=u*(d*d-e*e)/(e*e);c=d/1024*(256+d*(-128+d*(74-47*d)));return(e*(1+d/16384*(4096+d*(-768+d*(320-175*d))))*(t-c*p*(r+c/4*(n*(-1+2*r*r)-c/6*r*(-3+4*p*p)*(-3+4*r*r))))).toFixed(3)/1E3};
GeoGlobe.Util.destinationVincenty=function(a,b,c){for(var d=GeoGlobe.Util,e=d.VincentyConstants,f=e.a,g=e.b,e=e.f,h=a.lng,j=a.lat,a=d.rad(b),b=Math.sin(a),a=Math.cos(a),l=(1-e)*Math.tan(d.rad(j)),j=1/Math.sqrt(1+l*l),m=l*j,o=Math.atan2(l,a),l=j*b,q=1-l*l,f=q*(f*f-g*g)/(g*g),r=1+f/16384*(4096+f*(-768+f*(320-175*f))),n=f/1024*(256+f*(-128+f*(74-47*f))),f=c/(g*r),p=2*Math.PI;Math.abs(f-p)>1.0E-12;)var t=Math.cos(2*o+f),s=Math.sin(f),u=Math.cos(f),v=n*s*(t+n/4*(u*(-1+2*t*t)-n/6*t*(-3+4*s*s)*(-3+4*t*t))),
p=f,f=c/(g*r)+v;c=m*s-j*u*a;c=Math.atan2(m*u+j*s*a,(1-e)*Math.sqrt(l*l+c*c));g=e/16*q*(4+e*(4-3*q));return new GeoGlobe.LngLat(h+d.deg(Math.atan2(s*b,j*u-m*s*a)-(1-g)*e*l*(f+g*s*(t+g*u*(-1+2*t*t)))),d.deg(c))};
...
b.prototype=a.prototype;if(g&&f.wrapped)b.wrapped=f.wrapped;b.UNSENT=0;b.OPENED=1;b.HEADERS_RECEIVED=2;b.LOADING=3;b.DONE=4;b.prototype.readyState=b.UNSENT;b.prototype.responseText="";b.prototype.responseXML=null;b.prototype.status=0;b.prototype.statusText="";b.prototype.priority="NORMAL";b.prototype.onreadystatechange=null;b.onreadystatechange=null;b.onopen=null;b.onsend=null;b.onabort=null;b.prototype.open=function(a,f,j,q,r){delete this._headers;arguments.length<3&&(j=!0);this._async=j;var n=this,
p=this.readyState,t;h&&j&&(t=function(){p!=b.DONE&&(e(n),n.abort())},window.attachEvent("onunload",t));b.onopen&&b.onopen.apply(this,arguments);arguments.length>4?this._object.open(a,f,j,q,r):arguments.length>3?this._object.open(a,f,j,q):this._object.open(a,f,j);try{this._object.responseType="msxml-document"}catch(s){}this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j)n.readyState=n._object.readyState,d(n),n._aborted?n.readyState=b.UNSENT:(n.readyState==b.DONE&&(delete n._data,
e(n),h&&j&&window.detachEvent("onunload",t)),p!=n.readyState&&c(n),p=n.readyState)}};b.prototype.setTimeout=function(a){this._object.timeout=a};b.prototype.send=function(a){b.onsend&&b.onsend.apply(this,arguments);arguments.length||(a=null);a&&a.nodeType&&(a=window.XMLSerializer?(new window.XMLSerializer).serializeToString(a):a.xml,this._headers["Content-Type"]||this._object.setRequestHeader("Content-Type","application/xml"));this._data=a;this._object.send(this._data);if(g&&!this._async){this.readyState=
...
e,f,g,h,j,l,m,o=0,q=d.length;a:for(;o<q;++o){c=d[o];e=c.x1;f=c.x2;g=c.y1;h=c.y2;var r=0,n=a.length;for(;r<n;++r){j=a[r];if(j.x1>f)break;if(!(j.x2<e)&&(l=j.y1,m=j.y2,!(Math.min(l,m)>Math.max(g,h))&&!(Math.max(l,m)<Math.min(g,h))&&GeoGlobe.Geometry.segmentsIntersect(c,j))){b=!0;break a}}}}else b=a.intersects(this);return b},getSortedSegments:function(){for(var a=this.components.length-1,b=Array(a),c,d,e=0;e<a;++e)c=this.components[e],d=this.components[e+1],b[e]=c.x<d.x?{x1:c.x,y1:c.y,x2:d.x,y2:d.y}:
{x1:d.x,y1:d.y,x2:c.x,y2:c.y};return b.sort(function(a,b){return a.x1-b.x1})},splitWithSegment:function(a,b){for(var c=!(b&&b.edge===!1),d=b&&b.tolerance,e=[],f=this.getVertices(),g=[],h=[],j=!1,l,m,o,q={point:!0,tolerance:d},r=null,n=0,p=f.length-2;n<=p;++n)if(d=f[n],g.push(d.clone()),l=f[n+1],m={x1:d.x,y1:d.y,x2:l.x,y2:l.y},m=GeoGlobe.Geometry.segmentsIntersect(a,m,q),m instanceof GeoGlobe.Geometry.Point&&((o=m.x===a.x1&&m.y===a.y1||m.x===a.x2&&m.y===a.y2||m.equals(d)||m.equals(l)?!0:!1)||c))m.equals(h[h.length-
1])||h.push(m.clone()),!(n===0&&m.equals(d))&&!m.equals(l)&&(j=!0,m.equals(d)||g.push(m),e.push(new GeoGlobe.Geometry.LineString(g)),g=[m.clone()]);j&&(g.push(l.clone()),e.push(new GeoGlobe.Geometry.LineString(g)));if(h.length>0)var t=a.x1<a.x2?1:-1,s=a.y1<a.y2?1:-1,r={lines:e,points:h.sort(function(a,b){return t*a.x-t*b.x||s*a.y-s*b.y})};return r},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof GeoGlobe.Geometry.LineString){var j=this.getVertices(),l,m,o,q,r,n=[];g=[];for(var p=
0,t=j.length-2;p<=t;++p){l=j[p];m=j[p+1];o={x1:l.x,y1:l.y,x2:m.x,y2:m.y};h=h||[a];d&&n.push(l.clone());for(var s=0;s<h.length;++s)if(q=h[s].splitWithSegment(o,b))if(r=q.lines,r.length>0&&(r.unshift(s,1),Array.prototype.splice.apply(h,r),s+=r.length-2),d)for(var u=0,v=q.points.length;u<v;++u)r=q.points[u],r.equals(l)||(n.push(r),g.push(new GeoGlobe.Geometry.LineString(n)),n=r.equals(m)?[]:[r.clone()])}d&&g.length>0&&n.length>0&&(n.push(m.clone()),g.push(new GeoGlobe.Geometry.LineString(n)))}else c=
...
if(b.length<3)return this;var c=function(a,b,d,j){for(var l=0,m=0,o=b,q;o<d;o++)q=Math.abs(0.5*(a[b].x*a[d].y+a[d].x*a[o].y+a[o].x*a[b].y-a[d].x*a[b].y-a[o].x*a[d].y-a[b].x*a[o].y))/Math.sqrt(Math.pow(a[b].x-a[d].x,2)+Math.pow(a[b].y-a[d].y,2))*2,q>l&&(l=q,m=o);l>j&&m!=b&&(e.push(m),c(a,b,m,j),c(a,m,d,j))},d=b.length-1,e=[];e.push(0);for(e.push(d);b[0].equals(b[d]);)d--,e.push(d);c(b,0,d,a);a=[];e.sort(function(a,b){return a-b});for(d=0;d<e.length;d++)a.push(b[e[d]]);return new GeoGlobe.Geometry.LineString(a)}else return this},
...
a.features?a.features.length:0,c=Array(b),e=0;e<b;++e)c[e]=a.features[e].fid;n.insertIds=c;d.apply(this,[a])}function d(a){this.callUserCallback(a,b);r=r&&a.success();f++;if(f>=q&&b.callback)n.code=r?GeoGlobe.Protocol.Response.SUCCESS:GeoGlobe.Protocol.Response.FAILURE,b.callback.apply(b.scope,[n])}var b=GeoGlobe.Util.applyDefaults(b,this.options),e=[],f=0,g={};g[GeoGlobe.State.INSERT]=[];g[GeoGlobe.State.UPDATE]=[];g[GeoGlobe.State.DELETE]=[];for(var h,j,l=[],m=0,o=a.length;m<o;++m)if(h=a[m],j=g[h.state])j.push(h),
l.push(h);var q=(g[GeoGlobe.State.INSERT].length>0?1:0)+g[GeoGlobe.State.UPDATE].length+g[GeoGlobe.State.DELETE].length,r=!0,n=new GeoGlobe.Protocol.Response({reqFeatures:l});h=g[GeoGlobe.State.INSERT];h.length>0&&e.push(this.create(h,GeoGlobe.Util.applyDefaults({callback:c,scope:this},b.create)));h=g[GeoGlobe.State.UPDATE];for(m=h.length-1;m>=0;--m)e.push(this.update(h[m],GeoGlobe.Util.applyDefaults({callback:d,scope:this},b.update)));h=g[GeoGlobe.State.DELETE];for(m=h.length-1;m>=0;--m)e.push(this["delete"](h[m],
...
d);break;case "polystyle":d=this.parseProperty(e,"*","color");if(d=this.parseKmlColor(d))b.fillOpacity=d.opacity,b.fillColor=d.color;this.parseProperty(e,"*","fill")=="0"&&(b.fillColor="none");this.parseProperty(e,"*","outline")=="0"&&(b.strokeWidth="0");break;case "iconstyle":var h=parseFloat(this.parseProperty(e,"*","scale")||1);d=32*h;var j=32*h,l=this.getElementsByTagNameNS(e,"*","Icon")[0];if(l){var m=this.parseProperty(l,"*","href");if(m){var o=this.parseProperty(l,"*","w"),q=this.parseProperty(l,
"*","h");GeoGlobe.String.startsWith(m,"http://maps.google.com/mapfiles/kml")&&!o&&!q&&(q=o=64,h/=2);o=o||q;q=q||o;o&&(d=parseInt(o)*h);q&&(j=parseInt(q)*h);if(q=m.match(this.regExes.kmlIconPalette))o=q[1],q=q[2],m=this.parseProperty(l,"*","x"),l=this.parseProperty(l,"*","y"),m="http://maps.google.com/mapfiles/kml/pal"+o+"/icon"+((l?7-l/32:7)*8+(m?m/32:0))+q;b.graphicOpacity=1;b.externalGraphic=m}}if(e=this.getElementsByTagNameNS(e,"*","hotSpot")[0])m=parseFloat(e.getAttribute("x")),l=parseFloat(e.getAttribute("y")),
...
(g[o.identifier]=o["default"])}for(var q=c.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),r=c.units||(q==="EPSG:4326"?"degrees":"m"),n=[],p,t,c=[],m=e.tileMatrixSetLinks,g=function(a){n.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[r]);if(!p||p>a)p=a;if(!t||t<a)t=a},o=0,j=m.length;o<j;o++)if(f=m[o],f.tileMatrixSet===h.identifier){if(f.tileMatrixSetLimits){for(var j={},o=0,s=h.matrixIds.length;o<s;o++)j[h.matrixIds[o].identifier]=h.matrixIds[o];o=
0;for(s=f.tileMatrixSetLimits.length;o<s;o++)m=j[f.tileMatrixSetLimits[o].tileMatrix],c.push(m),g(m.scaleDenominator)}else{o=0;for(s=h.matrixIds.length;o<s;o++)g(h.matrixIds[o].scaleDenominator)}break}n.sort(function(a,b){return b-a});var u="",v={layers:[],source:{},source_id:"",url:"",url_tmpl:"",layerType:"VTS"},b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,TILEMATRIXSET:h.identifier,FORMAT:"protobuf",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});
...
a.scaleDenominator*d/f),a.units=="degrees"&&(c=a.scaleDenominator*d/(f*e)),a.units!=="m"&&a.units!=="degrees"){alert("\u8bf7\u786e\u5b9a\u5355\u4f4d\u662fm\u8fd8\u662fdegrees");return}g[0]=a.topLeftCorner[0];g[3]=a.topLeftCorner[1];g[1]=g[3]-a.tileSize*c*l;g[2]=g[0]+a.tileSize*c*l;d=j-Number(a.identifier);h[0]=(g[0]+g[2])/2;h[1]=(g[1]+g[3])/2;e=d-1;if((g[2]-g[0]<360||g[3]-g[1]<360)&&a.units=="degrees")d=Math.ceil(Math.log(360/(a.tileSize*c*l))/Math.LN2),e=Math.pow(2,d),g[1]=g[3]-a.tileSize*c*l*e,
g[2]=g[0]+a.tileSize*c*l*e,h[0]=(g[0]+g[2])/2,h[1]=(g[1]+g[3])/2,e=d-1;b.topTileExtent=g;b.zoomOffset=d;b.centerPoint=h;b.proposalZoom=e;return b},CLASS_NAME:"GeoGlobe.Format.WMTS"});
...
(c="KVP");var m=[],e=b.params||{};delete b.params;f=0;for(j=d.dimensions.length;f<j;f++){var o=d.dimensions[f];m.push(o.identifier);e.hasOwnProperty(o.identifier)||(e[o.identifier]=o["default"])}for(var m=b.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),q=b.units||(m==="EPSG:4326"?"degrees":"m"),r=[],n,p,m=[],o=d.tileMatrixSetLinks,f=function(a){r.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[q]);if(!n||n>a)n=a;if(!p||p<a)p=a},t=0,j=o.length;t<j;t++)if(e=
o[t],e.tileMatrixSet===h.identifier){if(e.tileMatrixSetLimits){for(var j={},t=0,s=h.matrixIds.length;t<s;t++)j[h.matrixIds[t].identifier]=h.matrixIds[t];t=0;for(s=e.tileMatrixSetLimits.length;t<s;t++)o=j[e.tileMatrixSetLimits[t].tileMatrix],m.push(o),f(o.scaleDenominator)}else{t=0;for(s=h.matrixIds.length;t<s;t++)f(h.matrixIds[t].scaleDenominator)}break}if(c==="REST"&&d.resourceUrls){m=[];e=0;for(f=d.resourceUrls.length;e<f;++e)c=d.resourceUrls[e],c.format===g&&c.resourceType==="tile"&&m.push(c.template)}else{j=
a.operationsMetadata.GetTile.dcp.http.get;m=[];e=0;for(f=j.length;e<f;e++)o=j[e].constraints,(!o||o&&o.GetEncoding.allowedValues[c])&&m.push(j[e].url)}r.sort(function(a,b){return b-a});c="";g="SERVICE=WMTS&REQUEST=GetTile&VERSION="+a.version+"&LAYER="+d.identifier+"&STYLE="+l.identifier+"&TILEMATRIXSET="+h.identifier+"&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT="+g;c=m[0].endsWith("?")?m[0]+g:m[0]+"?"+g;g=GeoGlobe.Util.applyDefaults(b,{id:d.identifier,url:[c]});g=new GeoGlobe.Layer.VTS(g);g.matrixSet=
...
1;if((g[2]-g[0]<360||g[3]-g[1]<360)&&a.units=="degrees")d=Math.ceil(Math.log(360/(a.tileSize*c*l))/Math.LN2),e=Math.pow(2,d),g[1]=g[3]-a.tileSize*c*l*e,g[2]=g[0]+a.tileSize*c*l*e,h[0]=(g[0]+g[2])/2,h[1]=(g[1]+g[3])/2,e=d-1;b.topTileExtent=g;b.zoomOffset=d;b.centerPoint=h;b.proposalZoom=e;return b},CLASS_NAME:"GeoGlobe.Format.WMTSUtil"});GeoGlobe.Format.WPSCapabilities=GeoGlobe.Class4OL(GeoGlobe.Format.XML.VersionedOGC,{defaultVersion:"1.0.0",CLASS_NAME:"GeoGlobe.Format.WPSCapabilities"});
...
"-":"+")=="-"?-1*b:b),c.setMinutes(c.getMinutes()-b-c.getTimezoneOffset())):a.indexOf("Z",a.length-1)!==-1&&(c=new Date(Date.UTC(c.getFullYear(),c.getMonth(),c.getDate(),c.getHours(),c.getMinutes(),c.getSeconds(),c.getMilliseconds())));return c}function g(b,c,e){return a.datetimeAccessFormPaths.length>0?(e=e.split(".#")[0],d(a.datetimeAccessFormPaths,b,c,e)?f(b):b):b}function h(c,f){if(c.nodeType==p.DOCUMENT_NODE){for(var j={},o=c.childNodes,n=0;n<o.length;n++){var l=o.item(n);if(l.nodeType==p.ELEMENT_NODE){var m=
b(l);j[m]=h(l,m)}}return j}else if(c.nodeType==p.ELEMENT_NODE){j={};j.__cnt=0;o=c.childNodes;for(n=0;n<o.length;n++)if(l=o.item(n),m=b(l),l.nodeType!=p.COMMENT_NODE){var r=f+"."+m;if(l.nodeType==p.ELEMENT_NODE&&a.xmlElementsFilter.length>0?d(a.xmlElementsFilter,j,m,r):1)j.__cnt++,j[m]==null?(j[m]=h(l,r),e(j,m,r)):(j[m]!=null&&!(j[m]instanceof Array)&&(j[m]=[j[m]],e(j,m,r)),j[m][j[m].length]=h(l,r))}for(o=0;o<c.attributes.length;o++)n=c.attributes.item(o),j.__cnt++,j[a.attributePrefix+n.name]=n.value;
...
b[c]instanceof Function?!0:!1}function o(a){var b=0;if(a instanceof Object)for(var c in a)m(a,c)||b++;return b}function q(b){var c=[];if(b instanceof Object)for(var d in b)d.toString().indexOf("__")==-1&&d.toString().indexOf(a.attributePrefix)==0&&c.push(d);return c}function r(b){var d="";if(b instanceof Object){var e="";b.__cdata!=null&&(e+="<![CDATA["+b.__cdata+"]]\>");b.__text!=null&&(e+=a.escapeMode?c(b.__text):b.__text);d+=e}else b!=null&&(d+=a.escapeMode?c(b):b);return d}function n(b,c){var e=
"";if(o(b)>0)for(var f in b){var g;if(!(g=m(b,f)))if(g=c!="")g=c===""?f:c+"."+f,g=!(a.jsonPropertiesFilter.length==0||g==""||d(a.jsonPropertiesFilter,b,f,g));if(!g){var h=b[f];g=q(h);if(h==null||h==void 0)e+=j(h,f,g,!0);else if(h instanceof Object)if(h instanceof Array){var p=f,A=c,B="";if(h.length==0)B+=j(h,p,g,!0);else for(g=0;g<h.length;g++)B+=j(h[g],p,q(h[g]),!1),B+=n(h[g],A===""?p:A+"."+p),B+=l(h[g],p);e+=B}else h instanceof Date?(e+=j(h,f,g,!1),e+=h.toISOString(),e+=l(h,f)):o(h)>0||h.__text!=
...
d.initZoom=q.Identifier.text;if(q.length>0){for(var j=0,r=q.length;j<r;j++){if(j==r)break;m+=q[j].ScaleDenominator.text+","}d.Scales=m.substr(0,m.length-1);d.zoomOffset=q[0].Identifier.text}else if(q)m+=q.ScaleDenominator.text+",",d.Scales=m.substr(0,m.length-1),d.zoomOffset=q.Identifier.text;c[l]=d}a(c,b)},b)},xmlToJson:function(a){var b={};if(a.nodeType==1){if(a.attributes.length>0){b.attributes={};for(var c=0;c<a.attributes.length;c++){var d=a.attributes.item(c);b.attributes[d.nodeName]=d.nodeValue}}}else if(a.nodeType==
...
180/Math.PI*(2*Math.atan(Math.exp(a*Math.PI/180))-Math.PI/2);return[b,a]},translate:function(a,b,c){var d=[];switch(b+"-"+c){case "1-2":for(b=0;b<a.length;b++)c=this.wgsBL2wgsMercator(a[b]),d.push(c);break;case "1-3":for(b=0;b<a.length;b++)c=this.wgs2gcj(a[b]),d.push(c);break;case "1-4":for(b=0;b<a.length;b++)c=this.wgs2gcj(a[b]),c=this.gcjTobaidu(c),d.push(c);break;case "1-5":for(b=0;b<a.length;b++)c=this.wgs2gcj(a[b]),c=this.gcjTobaidu(c),c=this.baiduBLTobaiduMercator(c),d.push(c);break;case "2-1":for(b=
0;b<a.length;b++)c=this.wgsMercator2wgsBL(a[b]),d.push(c);break;case "2-3":for(b=0;b<a.length;b++)c=this.wgsMercator2wgsBL(a[b]),c=this.wgs2gcj(c),d.push(c);break;case "2-4":for(b=0;b<a.length;b++)c=this.wgsMercator2wgsBL(a[b]),c=this.wgs2gcj(c),c=this.gcjTobaidu(c),d.push(c);break;case "2-5":for(b=0;b<a.length;b++)c=this.wgsMercator2wgsBL(a[b]),c=this.wgs2gcj(c),c=this.gcjTobaidu(c),c=this.baiduBLTobaiduMercator(c),d.push(c);break;case "3-1":for(b=0;b<a.length;b++)c=this.gcj2wgs(a[b]),d.push(c);
break;case "3-2":for(b=0;b<a.length;b++)c=this.gcj2wgs(a[b]),c=this.wgsBL2wgsMercator(c),d.push(c);break;case "3-4":for(b=0;b<a.length;b++)c=this.gcjTobaidu(a[b]),d.push(c);break;case "3-5":for(b=0;b<a.length;b++)c=this.gcjTobaidu(a[b]),c=this.baiduBLTobaiduMercator(c),d.push(c);break;case "4-1":for(b=0;b<a.length;b++)c=this.baiduTogcj(a[b]),c=this.gcj2wgs(c),d.push(c);break;case "4-2":for(b=0;b<a.length;b++)c=this.baiduTogcj(a[b]),c=this.gcj2wgs(c),c=this.wgsBL2wgsMercator(c),d.push(c);break;case "4-3":for(b=
0;b<a.length;b++)c=this.baiduTogcj(a[b]),d.push(c);break;case "4-5":for(b=0;b<a.length;b++)c=this.baiduBLTobaiduMercator(a[b]),d.push(c);break;case "5-1":for(b=0;b<a.length;b++)c=this.baiduMercatorTobaiduBL(a[b]),c=this.baiduTogcj(c),c=this.gcj2wgs(c),d.push(c);break;case "5-2":for(b=0;b<a.length;b++)c=this.baiduMercatorTobaiduBL(a[b]),c=this.baiduTogcj(c),c=this.gcj2wgs(c),c=this.wgsBL2wgsMercator(c),d.push(c);break;case "5-3":for(b=0;b<a.length;b++)c=this.baiduMercatorTobaiduBL(a[b]),c=this.baiduTogcj(c),
d.push(c);break;case "5-4":for(b=0;b<a.length;b++)c=this.baiduMercatorTobaiduBL(a[b]),d.push(c);break;default:console.warn("from "+b+"\u6216to "+c+"\u4e0d\u5728\u89c4\u5b9a\u7684\u7f16\u53f7\u5185\uff01")}return d},CLASS_NAME:"GeoGlobe.Convertor"});
...
this._meshes.push(symbol)}this._three._render();this._animate()},_animate:function(){var a=this;a.autoplay&&(a._mixer&&a._mixer.update(a._clock.getDelta()),a._three._render(),requestAnimationFrame(function(){a._animate()}))}});
...
a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;this._three._removeInnerLayer(this);this._meshes=[];for(var b=[],c=[],d=[],e=[],f=0;f<this.data.length;f++){var g=this.data[f],h=this.getWidth(g),j=new THREE.Color(this.getColor(g)),l=new THREE.LineMaterial({linewidth:5.0E-4*h,color:j,opacity:1,transparent:!0}),m=[],o=[],q=[],r=this.data[f].geometry.coordinates;if(r.length>1)var n=this._three._threebox.projectToWorld(r[0]),p=this._three._threebox.projectToWorld(r[r.length-
1]),p=Math.sqrt(Math.pow(p.x-n.x,2)+Math.pow(p.y-n.y,2)+Math.pow(p.z-n.z,2));for(var t=0;t<r.length-1;t++){var m=this._three._threebox.projectToWorld(r[t]),s=this._three._threebox.projectToWorld(r[t+1]),u={x:(m.x+s.x)/2,y:(m.y+s.y)/2,z:Math.sqrt(Math.pow(s.x-m.x,2)+Math.pow(s.y-m.y,2))/2*Math.tan(Math.PI/2*this.getCurveness(g))},u=new THREE.QuadraticBezierCurve3(new THREE.Vector3(m.x,m.y,m.z),new THREE.Vector3(u.x,u.y,u.z),new THREE.Vector3(s.x,s.y,s.z));if(r.length>1)u.rate1=Math.sqrt(Math.pow(m.x-
n.x,2)+Math.pow(m.y-n.y,2)+Math.pow(m.z-n.z,2))/p,u.rate2=Math.sqrt(Math.pow(s.x-m.x,2)+Math.pow(s.y-m.y,2)+Math.pow(s.z-m.z,2))/p;q.push(u);m=u.getPoints(50);for(s=0;s<m.length;s++)o.push(m[s].x,m[s].y,m[s].z)}r=new THREE.LineGeometry;r.setPositions(o);l=new THREE.Line2(r,l);l.computeLineDistances();l.visible=this.visible;l.name=(this.id?this.id:"threelayer")+"-"+f;l.userData.attributes={OriginalData:g,Layer:this};this._three._threebox.addGeoreferencedMesh(l);this._meshes.push(l);b.push(o[0]);b.push(o[1]);
...
h=0,j=JSON.parse(b.data.properties.levels);j.forEach(function(a){h+=a});for(var l=b._three._threebox.distaneToWorld(h),m={steps:10,units:"kilometers",properties:{}},o=[],q=[],r=[],n=[],p=[],t=[],s=0;s<g.length;s++){var u=[],v=b._three._threebox.projectToWorld(g[s]);q.push(v.clone());var w=v.clone();w.z=l;r.push(w.clone());u.push(v.clone());u.push(w.clone());n.push(u);p.push(v.clone());t.push(v.clone());u=turf.circle(g[s],2.0E-4,m);o.push(u)}g=new THREE.MeshPhongMaterial({color:16777215,transparent:!0,
opacity:1});new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.5});q=b._createLineGeometry(q);m=b._createLineGeometry(r);r=q.clone();q=new THREE.Line(q,g);q.name="linebase";m=new THREE.Line(m,g);m.name="lineUp";c.add(q);c.add(m);l={pillar:{amount:l,bevelEnabled:!1},floor:{amount:1.0E-12,bevelEnabled:!1}};o=b._createPillarMesh(o,l.pillar,g);o.name="pillar";c.add(o);o=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.5});p=b._createGeoExtrudeGeometry(p,l.floor);for(q=
l=0;q<j.length;q++)g=b._three._threebox.distaneToWorld(l),n=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.1,specular:6454209,shininess:100}),m=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.05,specular:16776960,shininess:100,side:THREE.DoubleSide}),s=p.clone(),s.translate(0,0,g),n=new THREE.Mesh(s,n),n.userData.attributes={OriginalData:b.data,Layer:b,level:q+1,tag:"__floor__"},n.userData.tag="__floor__",n.name="this is "+(q+1)+" floor",c.add(n),b.isFloorLinesVisible&&
(n=r.clone(),n.translate(0,0,g),n=new THREE.Line(n,o),c.add(n)),n={amount:b._three._threebox.distaneToWorld(j[q]),bevelEnabled:!1},n=b._createSideGeometry(t,n),n.translate(0,0,g),g=new THREE.Mesh(n,m),g.userData.attributes={OriginalData:b.data,Layer:b,level:q+1,tag:"__wall__"},g.userData.tag="__wall__",g.name="this is "+(q+1)+" wall",c.add(g),l+=j[q];var j=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:1}),t=new THREE.SphereBufferGeometry(0.001,32,16),x=new THREE.Mesh(t,j);x.position.copy(b._three._threebox.projectToWorld([e[0],
...
a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a},identity:function(a){a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a},translate:function(a,b,c){var d=c[0],e=c[1],c=c[2],f,g,h,j,l,m,o,q,r,n,p,t;b===a?(a[12]=b[0]*d+b[4]*e+b[8]*c+b[12],a[13]=b[1]*d+b[5]*e+b[9]*c+b[13],a[14]=b[2]*d+b[6]*e+b[10]*c+b[14],a[15]=b[3]*d+b[7]*e+b[11]*c+b[15]):(f=b[0],
g=b[1],h=b[2],j=b[3],l=b[4],m=b[5],o=b[6],q=b[7],r=b[8],n=b[9],p=b[10],t=b[11],a[0]=f,a[1]=g,a[2]=h,a[3]=j,a[4]=l,a[5]=m,a[6]=o,a[7]=q,a[8]=r,a[9]=n,a[10]=p,a[11]=t,a[12]=f*d+l*e+r*c+b[12],a[13]=g*d+m*e+n*c+b[13],a[14]=h*d+o*e+p*c+b[14],a[15]=j*d+q*e+t*c+b[15]);return a},scale:function(a,b,c){var d=c[0],e=c[1],c=c[2];a[0]=b[0]*d;a[1]=b[1]*d;a[2]=b[2]*d;a[3]=b[3]*d;a[4]=b[4]*e;a[5]=b[5]*e;a[6]=b[6]*e;a[7]=b[7]*e;a[8]=b[8]*c;a[9]=b[9]*c;a[10]=b[10]*c;a[11]=b[11]*c;a[12]=b[12];a[13]=b[13];a[14]=b[14];
a[15]=b[15];return a},multiply:function(a,b,c){var d=b[0],e=b[1],f=b[2],g=b[3],h=b[4],j=b[5],l=b[6],m=b[7],o=b[8],q=b[9],r=b[10],n=b[11],p=b[12],t=b[13],s=b[14],b=b[15],u=c[0],v=c[1],w=c[2],x=c[3];a[0]=u*d+v*h+w*o+x*p;a[1]=u*e+v*j+w*q+x*t;a[2]=u*f+v*l+w*r+x*s;a[3]=u*g+v*m+w*n+x*b;u=c[4];v=c[5];w=c[6];x=c[7];a[4]=u*d+v*h+w*o+x*p;a[5]=u*e+v*j+w*q+x*t;a[6]=u*f+v*l+w*r+x*s;a[7]=u*g+v*m+w*n+x*b;u=c[8];v=c[9];w=c[10];x=c[11];a[8]=u*d+v*h+w*o+x*p;a[9]=u*e+v*j+w*q+x*t;a[10]=u*f+v*l+w*r+x*s;a[11]=u*g+v*m+
w*n+x*b;u=c[12];v=c[13];w=c[14];x=c[15];a[12]=u*d+v*h+w*o+x*p;a[13]=u*e+v*j+w*q+x*t;a[14]=u*f+v*l+w*r+x*s;a[15]=u*g+v*m+w*n+x*b;return a},perspective:function(a,b,c,d,e){var b=1/Math.tan(b/2),f=1/(d-e);a[0]=b/c;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=b;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=(e+d)*f;a[11]=-1;a[12]=0;a[13]=0;a[14]=2*e*d*f;a[15]=0;return a},rotateX:function(a,b,c){var d=Math.sin(c),c=Math.cos(c),e=b[4],f=b[5],g=b[6],h=b[7],j=b[8],l=b[9],m=b[10],o=b[11];b!==a&&(a[0]=b[0],a[1]=b[1],a[2]=b[2],a[3]=
...
b){var c=b[0],d=b[1],e=b[2],f=b[3],g=b[4],h=b[5],j=b[6],l=b[7],m=b[8],o=b[9],q=b[10],r=b[11],n=b[12],p=b[13],t=b[14],s=b[15],u=c*h-d*g,v=c*j-e*g,w=c*l-f*g,x=d*j-e*h,C=d*l-f*h,A=e*l-f*j,B=m*p-o*n,y=m*t-q*n,z=m*s-r*n,E=o*t-q*p,F=o*s-r*p,G=q*s-r*t,D=u*G-v*F+w*E+x*z-C*y+A*B;if(!D)return null;D=1/D;a[0]=(h*G-j*F+l*E)*D;a[1]=(e*F-d*G-f*E)*D;a[2]=(p*A-t*C+s*x)*D;a[3]=(q*C-o*A-r*x)*D;a[4]=(j*z-g*G-l*y)*D;a[5]=(c*G-e*z+f*y)*D;a[6]=(t*w-n*A-s*v)*D;a[7]=(m*A-q*w+r*v)*D;a[8]=(g*F-h*z+l*B)*D;a[9]=(d*z-c*F-f*B)*
D;a[10]=(n*C-p*w+s*u)*D;a[11]=(o*w-m*C-r*u)*D;a[12]=(h*y-g*E-j*B)*D;a[13]=(c*E-d*y+e*B)*D;a[14]=(p*v-n*x-t*u)*D;a[15]=(m*x-o*v+q*u)*D;return a},ortho:function(a,b,c,d,e,f,g){var h=1/(b-c),j=1/(d-e),l=1/(f-g);a[0]=-2*h;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=-2*j;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=2*l;a[11]=0;a[12]=(b+c)*h;a[13]=(e+d)*j;a[14]=(g+f)*l;a[15]=1;return a}}}});
...
c:this.value},b.formatter).split("<br/>"),o=m.length,q=0;q<o;q++){var r=c.measureText(m[q]).width;r>j&&(j=r);c.fillText(m[q],this.x,this.y-((o-1)/2-q)*(this.radius*2+5))}else j=c.measureText("\uffe5"+this.value).width;c.rect(this.x-j/2,this.y-l/2,j,l)}break;case "fire":c.rect(this.x-this.size/2,this.y-this.size/2,this.size,this.size);break;case "icon":c.rect(this.x-b.symbolWidth/2,this.y-b.symbolHeight/2,b.symbolWidth,b.symbolHeight)}if(c.isPointInPath(d,h))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=
...
"none"},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markLine:{hoverable:!0,curveness:0.6,effect:{color:"#fff",scaleSize:3,period:30},itemStyle:{color:null,width:1}},markPoint:{nameField:"name",valueField:"value",hoverable:!0,symbol:"emptyCircle",symbolMinSize:20,symbolMaxSize:40,effect:{scaleSize:2,period:30},itemStyle:{color:"rgba(255,0,0,0.5)",shadowColor:"#000000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0},label:{show:!0,color:"#fff",align:"center",baseline:"middle",
fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},tooltip:{show:!0,backgroundColor:"#fff",borderColor:"#333",borderRadius:0,borderWidth:0,padding:10,textStyle:{color:"#000",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._rendererOptions.markPoint.symbol,c=this._rendererOptions.markPoint.symbolMinSize,d=this._rendererOptions.markPoint.symbolMaxSize,e=this._rendererOptions.markPoint.effect,
...
render:function(){this._init_RendererOptions();this._initMarkPoint();this._initMarkLine();this._initTooltip();this.setData(this.data);this.draw()},draw:function(){this.updateXY();this.drawCanvas1();this.animation=!0;this.frame&&cancelAnimationFrame(this.frame);var a=this;(function c(){a.frame=requestAnimationFrame(c);a.animation&&a.drawCanvas2();a.animation&&a.drawCanvas3();a.animation=!0})()},onMove:function(){this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width;this.animation=!1;this.updateXY();
this.drawCanvas1();this.drawCanvas2();this.drawCanvas3()},onMoveEnd:function(){this.redraw()},onMouseMove:function(a){if(this.visibility&&(this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this.markPoints.length>0&&!this._parent.map.moving)this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a})},onResize:function(){this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=
this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height;this.redraw()},redraw:function(){this.clearCanvas();this.updateXY();this.drawCanvas1();this.drawCanvas2();this.drawCanvas3()},updateXY:function(){for(var a=this.markPoints.length;a--;)this.markPoints[a].updateXY(),
this.markLines[a].updateXY()},drawCanvas1:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markLines.length;a--;)this.markLines[a].draw(this.cacheCanvasContext[0]);for(a=this.markPoints.length;a--;)this.markPoints[a].draw1(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawCanvas2:function(){document.createElement("canvas").getContext?(this.cacheCanvasContext[1].globalCompositeOperation="destination-out",this.cacheCanvasContext[1].fillStyle=
"rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[1].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[1].globalCompositeOperation="source-over"):this.cacheCanvas[1].width=this.width;this.cacheCanvasContext[1].save();for(var a=this.markLines.length;a--;)this.markLines[a].effect.draw(this.cacheCanvasContext[1]);this.cacheCanvasContext[1].restore();this.canvas[1].width=this.width;this.canvasContext[1].drawImage(this.cacheCanvas[1],0,0)},drawCanvas3:function(){this._rendererOptions.markPoint.symbol===
"emptyCircle"?document.createElement("canvas").getContext?(this.cacheCanvasContext[2].globalCompositeOperation="destination-out",this.cacheCanvasContext[2].fillStyle="rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[2].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[2].globalCompositeOperation="source-over"):this.cacheCanvas[2].width=this.width:this._rendererOptions.markPoint.symbol==="ring"?(this.cacheCanvas[2].width=this.width,this.cacheCanvasContext[2].globalCompositeOperation="lighter"):
this.cacheCanvas[2].width=this.width;this.cacheCanvasContext[2].save();for(var a=this.markPoints.length;a--;)this.markPoints[a].draw2(this.cacheCanvasContext[2]);this.cacheCanvasContext[2].restore();this.canvas[2].width=this.width;this.canvasContext[2].drawImage(this.cacheCanvas[2],0,0)},clearCanvas:function(){this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width},stopDraw:function(){cancelAnimationFrame(this.frame);
this.clearCanvas()},destroy:function(){this.stopDraw();this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.hoveredMarkLine=null;this.lastHoveredMarkPoint=this.hoveredMarkPoint?GeoGlobe.Util.clone(this.hoveredMarkPoint):null;this.hoveredMarkPoint=null;var c,d;c=0;for(d=this.markLines.length;c<d;c++)!this.hoveredMarkLine&&
this.markLines[c].isPointInStroke(this.cacheCanvasContext[0],a,b);c=0;for(d=this.markPoints.length;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas1();this.hoveredMarkLine||this.hoveredMarkPoint?(this.showTooltip(this.hoveredMarkLine?this.hoveredMarkLine.start.name+" > "+this.hoveredMarkLine.end.name:this.hoveredMarkPoint.name,a,b),this.canvas[2].style.cursor="pointer"):(this.hideTooltip(),this.canvas[2].style.cursor="grab")},showTooltip:function(a,
b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=
this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":"none";a?this.draw():this.stopDraw()},setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties[this._rendererOptions.markPoint.valueField]<
this.minValue)this.minValue=a[b].properties[this._rendererOptions.markPoint.valueField];if(a[b].properties[this._rendererOptions.markPoint.valueField]>this.maxValue)this.maxValue=a[b].properties[this._rendererOptions.markPoint.valueField]}for(var c=new this.MarkPoint(void 0,this.location.name,0,this.location.lonLat[0],this.location.lonLat[1]),d=[],e=[],b=0;b<a.length;b++)d.push(new this.MarkPoint(b,a[b].properties[this._rendererOptions.markPoint.nameField],a[b].properties[this._rendererOptions.markPoint.valueField],
a[b].geometry.coordinates[0],a[b].geometry.coordinates[1])),e.push(this.direction==="out"?new this.MarkLine(b,c,d[b]):new this.MarkLine(b,d[b],c));this.hoveredMarkLine=this.hoveredMarkPoint=null;this.markPoints=d;this.markLines=e}});
...
w[l].get2d().y)}else c.lineTo(s.get2d().x,s.get2d().y)}if(c.isPointInPath(e,f)){a.hoveredMarkPoint=this;this.hActive=h;this.vActive=j;return}}}}};this.MarkPoint.prototype.draw=function(c){var e=a._rendererOptions.markPoint.slope;this.update();var f,n,p;p=!1;var t;switch(d){case "column":for(f=0;f<this.parts.length;f++)for(n=0;n<this.parts[f].cubes.length;n++)if(this.parts[f].cubes[n].height>0&&(p=!0,t=b[n]?b[n]:m.color,a.hoveredMarkPoint===this&&f===this.hActive&&n===this.vActive&&(t=GeoGlobe.Util.getShadeColor(t,
...
this.parts[f].cubes[n].vertexs[3][1]),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(t,-20),c.fill();if(p)c.lineWidth=0.3,c.globalAlpha=1,c.globalCompositeOperation="destination-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.strokeStyle="#fff",c.beginPath(),c.moveTo(this.x-this.parts.length/2*g-(this.parts.length/2-0.5)*j-5,this.y),c.lineTo(this.x+this.parts.length/2*g+(this.parts.length/2-0.5)*j+5,this.y),c.closePath(),c.stroke(),h!==0&&(c.beginPath(),c.moveTo(this.x-(h/2+5)*Math.cos(e),
this.y+(h/2+5)*Math.sin(e)),c.lineTo(this.x+(h/2+5)*Math.cos(e),this.y-(h/2+5)*Math.sin(e)),c.closePath(),c.stroke());break;case "pie":c.globalAlpha=l;for(f=0;f<1;f++){t=this.parts[f].uCentrePoint;var s=this.parts[f].tCentrePoint,u=this.parts[f].oUnderPoints,v=this.parts[f].oTopPoints,w=this.parts[f].iUnderPoints,x=this.parts[f].iTopPoints,C=!1;this.parts[f].size/2>g&&(C=!0);var A=Math.round(25),B=[],y=[],z=[],E=[];for(n=0;n<this.parts[f].sectors.length;n++)B.push(this.parts[f].sectors[n].angle),
y.push(this.parts[f].sectors[n].startIndex),z.push(Math.round(this.parts[f].sectors[n].endIndex*this.energy)),E.push(b[n]?b[n]:m.color);for(n=B.length-1;n>=0;n--)B[n]>0&&a.hoveredMarkPoint===this&&f===this.hActive&&n===this.vActive&&(E[n]=GeoGlobe.Util.getShadeColor(E[n],10));for(n=B.length-1;n>=0;n--)if(B[n]>0){c.globalCompositeOperation="destination-over";c.beginPath();c.moveTo(u[z[n]].get2d().x,u[z[n]].get2d().y);for(p=z[n]-1;p>=y[n];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);if(C)for(p=y[n];p<=
z[n];p++)c.lineTo(w[p].get2d().x,w[p].get2d().y);else c.lineTo(t.get2d().x,t.get2d().y);c.fillStyle=E[n];c.fill()}if(e!==0){for(n=B.length-1;n>=0;n--)if(B[n]>0)c.globalCompositeOperation="source-over",c.beginPath(),c.moveTo(u[z[n]].get2d().x,u[z[n]].get2d().y),C?(c.lineTo(w[z[n]].get2d().x,w[z[n]].get2d().y),c.lineTo(x[z[n]].get2d().x,x[z[n]].get2d().y)):(c.lineTo(t.get2d().x,t.get2d().y),c.lineTo(s.get2d().x,s.get2d().y)),c.lineTo(v[z[n]].get2d().x,v[z[n]].get2d().y),c.moveTo(u[y[n]].get2d().x,u[y[n]].get2d().y),
C?(c.lineTo(w[y[n]].get2d().x,w[y[n]].get2d().y),c.lineTo(x[y[n]].get2d().x,x[y[n]].get2d().y)):(c.lineTo(t.get2d().x,t.get2d().y),c.lineTo(s.get2d().x,s.get2d().y)),c.lineTo(v[y[n]].get2d().x,v[y[n]].get2d().y),c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20),c.fill();if(C)for(n=B.length-1;n>=0;n--)if(B[n]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(w[z[n]].get2d().x,w[z[n]].get2d().y);if(y[n]<A&&z[n]>A){for(p=z[n]-1;p>=A;p--)c.lineTo(w[p].get2d().x,w[p].get2d().y);for(p=
A;p<=z[n];p++)c.lineTo(x[p].get2d().x,x[p].get2d().y);c.moveTo(w[y[n]].get2d().x,w[y[n]].get2d().y);for(p=y[n]+1;p<=A;p++)c.lineTo(w[p].get2d().x,w[p].get2d().y);for(p=A;p>=y[n];p--)c.lineTo(x[p].get2d().x,x[p].get2d().y)}else{for(p=z[n]-1;p>=y[n];p--)c.lineTo(w[p].get2d().x,w[p].get2d().y);for(p=y[n];p<=z[n];p++)c.lineTo(x[p].get2d().x,x[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20);c.fill()}for(n=B.length-1;n>=0;n--)if(B[n]>0){if(y[n]<A&&z[n]>A){c.globalCompositeOperation="destination-over";
c.beginPath();c.moveTo(u[z[n]].get2d().x,u[z[n]].get2d().y);for(p=z[n]-1;p>=A;p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=A;p<=z[n];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y);c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20);c.fill();c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(u[y[n]].get2d().x,u[y[n]].get2d().y);for(p=y[n]+1;p<=A;p++)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=A;p>=y[n];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y)}else{c.globalCompositeOperation="source-over";
c.beginPath();c.moveTo(u[z[n]].get2d().x,u[z[n]].get2d().y);for(p=z[n]-1;p>=y[n];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=y[n];p<=z[n];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20);c.fill()}for(n=B.length-1;n>=0;n--)if(B[n]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(v[z[n]].get2d().x,v[z[n]].get2d().y);for(p=z[n]-1;p>=y[n];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y);if(C)for(p=y[n];p<=z[n];p++)c.lineTo(x[p].get2d().x,
x[p].get2d().y);else c.lineTo(s.get2d().x,s.get2d().y);c.fillStyle=E[n];c.fill()}}}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0])},
...
g;this.legendCanvas.height=b;var h=function(b,c,d){this.legendCanvas.width=g;for(var e=!1,f,h,n=0,p=this._legend.vLegendLabels.length;n<p;n++){h=0;for(var t=this._legend.col;h<t;h++)if(n%this._legend.col===h){f=10+this._legend.itemWidth/2;for(var s=0;s<h;s++)f+=a[s]+10}h=10+this._legend.itemHeight/2+((this._legend.itemHeight<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemHeight)+10)*~~(n/this._legend.col);s=t=!1;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-
...
this.legendCanvasContext.rect(f+this._legend.itemWidth/2+10,h-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this._legend.vLegendLabels[n].toString()).width,this._legend.textStyle.fontSize);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=t=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(s=!0);if(s)this._legend.itemStatuses[n]=this._legend.itemStatuses[n]===0?1:0,this.SWITCH=!0,this.redraw();
var u=this._legend.itemStatuses[n]===0?"#808080":this._legend.itemColors[n]?this._legend.itemColors[n]:this._rendererOptions.markPoint.itemStyle.color,v=this._legend.itemStatuses[n]===0?"#808080":this._legend.textStyle.color,u=t||s?GeoGlobe.Util.getShadeColor(u,20):u,v=t||s?GeoGlobe.Util.getShadeColor(v,20):v;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);this.legendCanvasContext.fillStyle=
...
l=void 0,m=void 0,o=void 0,q=void 0,r=void 0,n=void 0;this.markPoints.forEach(function(a){l=Math.floor((a.mercator[0]-e._markPointSWMercator[0])/h);m=Math.floor((a.mercator[1]-e._markPointSWMercator[1])/h);o=l+"_"+m;if(g[o])g[o].count++,g[o].sumLonLat[0]+=a.lon,g[o].sumLonLat[1]+=a.lat,g[o].children.push(a);else if(g[o]={key:o,count:1,sumLonLat:[a.lon,a.lat],children:[a]},b>f)q=Math.floor((a.mercator[0]-e._markPointSWMercator[0])/j),r=Math.floor((a.mercator[1]-e._markPointSWMercator[1])/j),n=q+"_"+
...
a[d];var e={},f={},g=void 0,h=void 0;for(d in a)if(g=a[d],!f[d])for(var h=d.split("_"),j=+h[0],l=+h[1],m=-1;m<=1;m++)for(var o=-1;o<=1;o++)if(!(m===0&&o===0)){var q=j+m+"_"+(l+o);if(h=a[q]){var r=GeoGlobe.Util.transferToMercator([g.sumLonLat[0]/g.count,g.sumLonLat[1]/g.count]),n=GeoGlobe.Util.transferToMercator([h.sumLonLat[0]/h.count,h.sumLonLat[1]/h.count]),p=r[0]-n[0],r=r[1]-n[1];Math.sqrt(p*p+r*r)<=b&&(e[d]=e[d]||[],e[d].push(h),f[q]=1)}}for(var t in e)if(d=a[t]){f=e[t];for(g=0;g<f.length;g++)if(a[f[g].key])d.count+=
...
"#a0d0ff","#b5c0ff","#c6adff","#d49bff","#e185ff","#ec6dff","#ff1edb"]},{},this.rendererOptions)},_initWindy:function(){var a=this;this.Windy=function(){var b=a._rendererOptions.velocityScale,c=a._rendererOptions.maxWindIntensity,d=100,e=a._rendererOptions.lineWidth,f=a._rendererOptions.particleMultiplier,g=a._rendererOptions.opacity,h=a._rendererOptions.colors,j=[NaN,NaN,null],l=2*Math.PI,m=Math.pow(10,-5.2),o=function(a,b,c,d,e,f){var g=1-a,h=1-b,j=g*h;h*=a;g*=b;b*=a;a=c[0]*j+d[0]*h+e[0]*g+f[0]*
b;c=c[1]*j+d[1]*h+e[1]*g+f[1]*b;return[a,c,Math.sqrt(a*a+c*c)]},q=function(a,b){var c=a.data,d=b.data;return{header:a.header,data:function(a){return[c[a],d[a]]},interpolate:o}},r=function(a){var b=null,c=null;a.forEach(function(a){switch(a.header.parameterCategory+","+a.header.parameterNumber){case "2,2":b=a;break;case "2,3":c=a}});return q(b,c)},n=function(a){return a!==null&&a!==void 0},p=function(a,b,c){function d(b,c){var e=a[Math.round(b)];return e&&e[Math.round(c)]||j}d.release=function(){a=
...
(e-d),a=s(a/180*Math.PI),b=(b/180*Math.PI-c.west)*f;return[b,(e-a)*d]},v=function(a,c,d){var e=[],f=a.x;(function D(){for(var g=Date.now();f<a.width;){for(var h=f,j=[],n=a.y;n<=a.yMax;n+=2){var o;o=c.east-c.west;var q=c.width/(o/(Math.PI/180))*360/(2*Math.PI);o=[c.west/(Math.PI/180)+h/c.width*(o/(Math.PI/180)),180/Math.PI*(2*Math.atan(Math.exp((c.height+q/2*Math.log((1+Math.sin(c.south))/(1-Math.sin(c.south)))-n)/q))-Math.PI/2)];var r=o[0],s=o[1];if(isFinite(r)&&(o=C(r,s))){var q=o[0]*b,t=o[1]*b,
v=r,w=s,r=h,s=n,x=c,A=v<0?m:-m,H=w<0?m:-m,I=u(w,v+A,x),v=u(w+H,v,x),w=Math.cos(w/360*l),r=[(I[0]-r)/A/w,(I[1]-s)/A/w,(v[0]-r)/H,(v[1]-s)/H];o[0]=r[0]*q+r[2]*t;o[1]=r[1]*q+r[3]*t;j[n+1]=j[n]=o}}e[h+1]=e[h]=j;f+=2;if(Date.now()-g>1E3){setTimeout(D,25);return}}p(e,a,d)})()},w=function(b,j){function l(a){return a.charAt(0)=="#"?a.substring(1,7):a}function m(){p.forEach(function(a){a.length=0});r.forEach(function(a){if(a.age>d)j.randomize(a).age=0;var b=a.x,c=a.y,e=j(b,c),f=e[2];f===null?a.age=d:(b+=e[0],
...
this.bounds[1][1]],this.bounds[1],[this.bounds[1][0],this.bounds[0][1]],this.bounds[0]]);this.draw()},_calculateBoundsAndSize:function(){this.bounds=this._parent.getBounds();var a=this._parent.map.transform.locationCoordinate({lng:this.bounds[0][0],lat:this.bounds[0][1]}),b=this._parent.map.transform.locationCoordinate({lng:this.bounds[1][0],lat:this.bounds[1][1]});this.size=a.hasOwnProperty("x")&&a.hasOwnProperty("y")?[Math.abs(a.x-b.x)*this._parent.map.transform.scale*this._parent.map.transform.tileSize,
Math.abs(a.y-b.y)*this._parent.map.transform.scale*this._parent.map.transform.tileSize]:[Math.abs(a.column-b.column)*this._parent.map.transform.tileSize,Math.abs(a.row-b.row)*this._parent.map.transform.tileSize]},clearCanvas:function(){this.canvasContext.clearRect(0,0,this.canvas.width,this.canvas.height)},stopDraw:function(){this.clearCanvas();this.windy.stop()},destroy:function(){this.stopDraw();this.Windy=this.windy=this.canvasContext=this.canvas=this._parent=null},addTo:function(a){this._parent=
a;this._parent.addLayer(this);this._calculateBoundsAndSize();this.canvas.width=Math.round(this.size[0]);this.canvas.height=Math.round(this.size[1]);this._parent.map.addSource(this.id+"_source",{type:"canvas",canvas:this.canvas,animate:!0,coordinates:[[this.bounds[0][0],this.bounds[1][1]],this.bounds[1],[this.bounds[1][0],this.bounds[0][1]],this.bounds[0]]});this._parent.map.addLayer({type:"raster",id:this.id+"_layer",source:this.id+"_source"});this.source=this._parent.map.getSource(this.id+"_source");
this.layer=this._parent.map.getLayer(this.id+"_layer");this.width=this._parent.map.transform.width;this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this._parent.map.setLayoutProperty(this.id+"_layer","visibility",a?"visible":"none");a?this.draw():this.stopDraw()},setData:function(a){this.data=a;this.windy=new this.Windy}});
