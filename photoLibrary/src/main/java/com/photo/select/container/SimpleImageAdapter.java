package com.photo.select.container;
...
import com.photo.select.preview.MultiImgShowActivity;
...
public class SimpleImageAdapter extends CommonAdapter<String> implements Serializable {
